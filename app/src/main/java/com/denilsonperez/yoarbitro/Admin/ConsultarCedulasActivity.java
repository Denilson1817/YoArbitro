...
public class ConsultarCedulasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.cerrarSesion: {
                        ...
                        Toast.makeText(ConsultarCedulasActivity.this, "Sesión finalizada", Toast.LENGTH_SHORT).show();
                        finish();
                        break;
                    }
                }
        ...
        listView = findViewById(R.id.lv_datosCedulas);
        ...
        carpetaReferencia.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                for (StorageReference archivo : archivos) {
                    ...
                    Toast.makeText(ConsultarCedulasActivity.this, "Jalando pdfs", Toast.LENGTH_SHORT).show();
        ...
        archivoReferencia.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                try {
                    ...
                    Toast.makeText(ConsultarCedulasActivity.this, "No se encontró una aplicación para abrir el archivo", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(ConsultarCedulasActivity.this, "Error al obtener la URL de descarga del archivo", Toast.LENGTH_SHORT).show();
            }
        });
    }
